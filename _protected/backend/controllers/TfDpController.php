...
class TfDpController extends Controller
{
    ...
    public function actionPush(){  
        ...
        $pusher = new Pusher(
            ...
            '750509',
            $options);
        $data['message'] = 'Pembayaran down payment anda telah disetujui, dan dinyatakan lunas';
    /*if (isset($_POST['submit'])) {
     ...
     public function actionPush2(){  
        ...
        $data['message'] = 'Maaf pembayaran down payment anda belum dapat di setujui, silahkan di cek kembali';
    /*if (isset($_POST['submit'])) {
            $data = array();
            $data['user'] =  $_POST['nama'];
            $data['message'] = $_POST['message'];
