...
<?php } ?>
  ...
  <tr>
    ...
    <td> : Rp <?=number_format($tot['biaya'] * $tot['jml_org'],0,",",".");?>,-</td>
<?php }?>
  </tr>
  <tr>
...
<table>
  ...
  <tr >
    ...
    <td align="center"> Pembayaran Lunas Tour <?=$ngr['name']?> </td>
    <?php }?>
    <?php foreach($total as $total){?>
    <td align="center">Rp <?=number_format($total['biaya'] * $total['jml_org'],0,",",".");?>,-</td>
<?php }?>
  </tr>

 <tr>
    <th colspan="2">Total</th>
    <th>Rp <?=number_format($total['biaya'] * $total['jml_org'],0,",",".");?>,-</th> 
