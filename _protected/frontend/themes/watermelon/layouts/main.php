...
<head>
    ...
    /*** TF PALETTE ***/
body{background-color:#C9D787;}
.primary-color-dark, .list-group-item.active, .list-group-item.active:focus, .list-group-item.active:hover{background-color:#FF8598 !important;border-color:#FF8598;}
nav.top-nav-collapse{background-color:#FFFFFF;}
.btn-primary, .btn-default, .btn-default:focus, .btn-default:hover, .btn-primary:focus, .btn-primary:hover{background-color:#FFC0A9 !important;}
body{color:#7D8A2E;}
    </style>
                            ...
                            <div id="carousel-example-2" class="carousel slide carousel-fade z-depth-1-half" data-ride="carousel">
                                ...
                                <div class="carousel-inner" role="listbox">
                                    <div class="carousel-item active">
                                        <img src="https://i.imgur.com/TSUU2oj.jpg" class="" alt="First slide">
                                    ...
                                    <div class="carousel-item">
                                        <img src="https://i.imgur.com/TJH4bX0.jpg" class="" alt="Second slide">
                                        <div class="carousel-caption">
                                            <h4>Get discount!</h4>
                                            <br>
                                        </div>
                                    ...
                                    <div class="carousel-item">
                                        <img src="https://i.imgur.com/SAVT2ku.jpg" class="" alt="Third slide">
                                        <div class="carousel-caption">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                ...
                                <div class="view overlay hm-white-slight">
                                    <img src="https://i.imgur.com/BjObV2N.jpg" class="img-fluid" alt="">
                                    <a href="#">
                                        <div class="mask"></div>
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                ...
                                <!--Card image-->
                                <div class="view overlay hm-white-slight">
                                    <img src="https://i.imgur.com/kvrsNpd.jpg" class="img-fluid" alt="">
                                    <a href="#">
                                        <div class="mask"></div>
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                ...
                                <!--Card image-->
                                <div class="view overlay hm-white-slight">
                                    <img src="https://i.imgur.com/fjih0J1.jpg" class="img-fluid" alt="">
                                    <a href="#">
                                        <div class="mask"></div>
                                    </a>
                                </div>
